...
def loss_function(model: InversePINN):
    ...
    total_reg = l2_weight * l2_reg + tv_weight * tv_reg
...
def train_inverse_pinn():
    ...
    os.makedirs("ckpts_2kl2tv", exist_ok=True)
    BEST_CKPT = "ckpts_2kl2tv/BEST_MODEL.pth"
    best_loss = float("inf")
    ...
    torch.save(model.state_dict(), "inverse_pinn_2K_L2TV_run1.pth")
    ...
    np.savetxt("inverse_output_2K_L2TV_run1.csv", out, delimiter=",", header="x,y,u_x,u_y,p,K", comments="")
