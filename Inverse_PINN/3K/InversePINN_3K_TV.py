...
def train_inverse_pinn():
    ...
    os.makedirs("ckpts_3ktv", exist_ok=True)
    BEST_CKPT = "ckpts_3ktv/BEST_MODEL.pth"
    best_loss = float("inf")
    ...
    torch.save(model.state_dict(), "inverse_output_3K_TV_run1.pth")
    ...
    np.savetxt("inverse_output_3K_TV_run1.csv", out, delimiter=",", header="x,y,u_x,u_y,p,K", comments="")
